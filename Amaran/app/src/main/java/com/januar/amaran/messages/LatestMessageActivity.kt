...
import com.januar.amaran.messages.NewMessageActivity.Companion.USER_KEY
import com.januar.amaran.models.ChatMessage
import com.januar.amaran.models.User
import com.januar.amaran.registerlogin.RegisterActivity
import com.januar.amaran.views.LatestMessageRow
    ...
    private fun fetchCurrentUser(){
        ...
        ref.addListenerForSingleValueEvent(object: ValueEventListener{
            override fun onDataChange(p0: DataSnapshot) {
                ...
                Log.d("LatestMessage", "Curent User: ${currentUser?.username}")
            }
